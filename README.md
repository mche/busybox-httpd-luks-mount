...
### Собственный алгоритм комбинации ключа

В ***cgi-bin/luks-key.sh*** представлен просто пример наложения двух частей в единый ключ.
Тут открываются широкие возможности для всевозможных алгоритмов.
